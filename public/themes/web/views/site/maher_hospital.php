		 ...
		 <div class="service-title">
			...
			<div class="container">
			  <div class="about-info service-img1">
				...
				<img class="jbox-img" src="<?php echo $path ; ?>/images/gallery/discharge.png" alt="Image 1" />
			   </div>
			   <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3 img-hover">
		        <img class="jbox-img" src="<?php echo $path ; ?>/images/gallery/ipd_entry.png" alt="Image 2" />
		    </div>
		    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3 img-hover">
		        <img class="jbox-img" src="<?php echo $path ; ?>/images/gallery/ipd_gynaecology.png" alt="Image 3" />
		    </div>
		    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3 img-hover">
		        <img class="jbox-img" src="<?php echo $path ; ?>/images/gallery/ipd_obestetric.png" alt="Image 4" />
		    </div>
		    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3 img-hover">
		        <img class="jbox-img" src="<?php echo $path ; ?>/images/gallery/main_form.jpg" alt="Image 5" />
		    </div>
		    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3 img-hover">
		        <img class="jbox-img" src="<?php echo $path ; ?>/images/gallery/opd.jpg" alt="Image 6" />
		    </div>
		    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3 img-hover">
		        <img class="jbox-img" src="<?php echo $path ; ?>/images/gallery/prescription.png" alt="Image 7" />
		    </div>
		   
		    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3 img-hover">
		        <img class="jbox-img" src="<?php echo $path ; ?>/images/gallery/reports_as_per_date.png" alt="Image 9" />
		    </div>
		     <!-- <div class="col-md-3">
